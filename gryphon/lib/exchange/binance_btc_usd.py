...
class BinanceBTCUSDExchange(ExchangeAPIWrapper):
    def __init__(self, session=None, configuration=None):
        ...
        self.base_url = 'https://www.binance.com/fapi/v1'
        self.currency = 'USD'
        self.bid_string = 'buy'
        self.ask_string = 'sell'
        self.nonce = 1
        self.ticker_symbols = 'BTCUSDT'

        # Configurables with defaults.
        self.market_order_fee =  Decimal('0.0004') 
        self.limit_order_fee =  Decimal('0.0002')  # https://www.binance.com/en/fee/futureFee
        self.fee = Decimal('0.0004')  # TODO: update these.
    ...
    def get_depth(self):
        ...
        requested = self.req('get', self.market_depth_url, no_auth=True, params=payload,)
        print "depth:"
        print requested
        return self.resp(requested)
    ...
    def _generate_signature(self, data):
        """
        Generate signature for binance futures API
        """
